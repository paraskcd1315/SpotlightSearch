...
import com.paraskcd.spotlightsearch.data.migrations.MIGRATION_3_4
...
object SettingsDatabaseModule {
    ...
    @Provides
    @Singleton
    fun provideBlackListAppsRepository(dao: BlacklistAppsDao): BlacklistAppsRepository =
        BlacklistAppsRepository(dao)
}