...
object AppAliases {
    val byPackage: Map<String, List<String>> = mapOf(
        ...
        "cat.atm.tmobilitat" to listOf("t-mobilitat", "transport", "public transport", "transporte publico"),
        "cat.gencat.mobi.rodalies" to listOf("rodalies", "transport", "public transport", "transporte publico"),
        ...
        "com.reddit.frontpage" to listOf("reddit", "social", "redes sociales", "social media", "community", "communities", "subreddit"),
        "com.remitly.androidapp" to listOf("remitly", "money transfer", "transferencia de dinero", "envío de dinero", "finanzas", "banco", "banking"),
        ...
        "com.tailscale.ipn" to listOf("tailscale", "seguridad", "vpn", "connect", "self hosted"),
        "com.termux" to listOf("termux", "terminal", "linux", "command line", "cli", "shell", "hacker", "hacking"),
        ...
        "com.discord" to listOf("discord", "chat", "comunidad", "server", "servidor"),
        "com.google.android.apps.docs.editors.docs" to listOf("docs", "documentos", "google docs", "editor de documentos"),
        ...
        "com.holded.app" to listOf("holded", "finanzas", "banco", "banking", "contabilidad", "accounting", "salary", "nómina", "invoices", "facturas", "salario"),
        "com.google.android.apps.chromecast.app" to listOf("chromecast", "cast", "streaming", "google cast", "google home"),
